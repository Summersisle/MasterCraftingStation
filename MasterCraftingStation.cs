...
namespace MasterCraftingStation
{
	...
	{
		public const string AssetPath = $"{nameof(MasterCraftingStation)}/Assets/";
		...
		public override void Load()
		{
			...
			//ExampleCustomCurrencyId = CustomCurrencyManager.RegisterCurrency(new Content.Currencies.ExampleCustomCurrency(ModContent.ItemType<Content.Items.ExampleItem>(), 999L, "Mods.MasterCraftingStation.Currencies.ExampleCustomCurrency"));
		}
